...
public class NewMove : MonoBehaviour
{
    ...
    {
        new Vector3(-84.86f, -6.94f, -43.62f),  // 第一段：X轴移动（无需转向）
        new Vector3(-84.86f, -6.94f, -151.14f),   // 第二段：Z轴移动（左转-90°）
        new Vector3(-148.4f, -6.94f, -151.14f),    // 第三段：X轴移动（右转+90°）
        new Vector3(-148.4f, -6.94f, -101.3f)    // 第三段：X轴移动（右转+90°）
    };
    ...
    void Start()
    {
        ...
        transform.position = new Vector3(-84.86f, -6.94f, -43.62f);
