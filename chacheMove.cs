...
public class chacheMove : MonoBehaviour
{
    // 路径点（Y坐标固定为-7.1）
    private Vector3[] waypoints = new Vector3[]
    {
        new Vector3(-75.71f, -8.38001f, 113.81f),  // 第一段：X轴移动（无需转向）
        new Vector3(-75.71f, -8.38001f, -16.2f),   // 第二段：Z轴移动（左转-90°）
        new Vector3(4.1f, -8.38001f, -16.2f),   // 第二段：Z轴移动（左转-90°）
    };
    ...
    void Start()
    {
        ...
        transform.position = new Vector3(-75.71f, -8.38001f, 113.81f);
